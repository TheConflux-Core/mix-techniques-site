...
export default function RegisterPage() {
  ...
  const validate = (): boolean => {
    ...
    if (form.password !== form.confirmPassword) {
      ...
      newShaking.add("confirmPassword");
    }
      ...
      <div className="flex flex-col min-h-screen page-enter">
        ...
        <main className="flex-1 flex items-center justify-center px-4 py-12 relative z-10">
          <div className="w-full max-w-md text-center animate-fade-in">
            <div className="success-icon text-7xl mb-6">✉️</div>
            <h2 className="heading-wave font-[family-name:var(--font-display)] text-3xl text-[#F0E6D3] mb-4 uppercase tracking-wider">
              Check Your Email
            </h2>
            <p className="font-[family-name:var(--font-mono)] text-[#F0E6D3]/60 text-sm mb-8 leading-relaxed">
              We sent a confirmation link to{" "}
              <span className="text-[#D4A843]">{form.email}</span>.
            ...
            <form ref={formRef} onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                <label className="block text-xs text-[#F0E6D3]/50 font-[family-name:var(--font-mono)] mb-2 uppercase tracking-[0.15em]">
                  Display Name <span className="text-[#D4A843]">*</span>
                </label>
                <input
                  type="text"
              ...
              <div>
                <label className="block text-xs text-[#F0E6D3]/50 font-[family-name:var(--font-mono)] mb-2 uppercase tracking-[0.15em]">
                  Confirm Password <span className="text-[#D4A843]">*</span>
                </label>
                <input
                  type="password"
