...
export default function Fader({
  ...
  return (
    ...
    >
      ...
      <div
        ref={bodyRef}
        className="relative w-[50px] h-[clamp(160px,30vh,240px)] mb-2.5 touch-none"
      ...
      >
        ...
        <div
          ...
          style={{
            ...
            transition: dragging ? "none" : "bottom 0.08s ease-out, box-shadow 0.15s",
            touchAction: "none",
          }}
      ...
      {/* Value */}
      <div
        className="text-[clamp(18px,2.5vw,24px)] font-bold min-w-[50px] text-center font-[family-name:var(--font-mono)]"
        style={{
